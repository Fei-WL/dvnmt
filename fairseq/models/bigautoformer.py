...
@register_model("bigautoformer")
class BigAutoformerModel(FairseqEncoderDecoderModel):
    @classmethod
    def hub_models(cls):
        # fmt: off
    ...
    def build_encoder(cls, args, src_dict, embed_tokens):
        return BigAutoformerEncoder(args, src_dict, embed_tokens)
...
class BigAutoformerEncoder(FairseqEncoder):
    """
    ...
    def build_encoder_layer(self, args):
        return BigAutoformerEncoderLayer(args)
...
@register_model_architecture("bigautoformer", "bigautoformer")
